...
//
//public class TopArtistsActivity extends PlayerActivity implements
//    OnClickListener {
//  private static String LOG_TAG = TopArtistsActivity.class.getName();
...
//    story = ArtistsListActivity.getStoryFromCache(storyId);
//
//    if (story == null) {
//      return;
//    }
